...
namespace CrazyMinnow.SALSA.RTVoice
{
    ...
    public class Salsa_RTVoice : MonoBehaviour
    {
        ...
        public string voice = "JennyNeural";
        ...
        void LateUpdate()
        {
            ...
            if (speak && Speaker.Instance.areVoicesReady)
            {
                speak = false;
                _isSpeaking = true;
                Speaker.Instance.Speak(speakText, audioSrc, Speaker.Instance.VoiceForName(voice, true));
            }
        }
    }
}